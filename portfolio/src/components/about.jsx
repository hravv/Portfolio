  ...
  return (
    <>
      ...
      <div>
        ...
        <p className='text-[1rem] md:text-[1.4rem] w-[65%] mx-auto text-center mb-10 '>
          Since I was little I've loved playing video games and, in recent years, have been streaming them to other people online. I enjoy horror and retro games most but all genres are fun to me. I spend a decent portion of my free time (and money) expanding my music collection, and have a record spinning most of the time I'm not busy.
        </p>
      </div>
    </>
  )
